...
maxResults = 50
playlist = "PLkJLSXv34hTE4T2uIGHBrorvcz1Kt8VUq"
...
def extract_video_data(video_ids):
    ...
    try:
        for batch in batch_list(video_ids, maxResults):
            ...
            url = f'https://youtube.googleapis.com/youtube/v3/videos?part=contentDetails&part=snippet&part=statistics&id={video_ids_str}A&key={API_KEY}'
